class ConcurrentCheckouts extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        this.apiUrl = `${this.baseUrl}/concurrent_checkouts/upload`;
        this.templateUrl = `${this.baseUrl}/concurrent_checkouts/component-template`;
...
customElements.define('concurrent-checkouts', ConcurrentCheckouts);