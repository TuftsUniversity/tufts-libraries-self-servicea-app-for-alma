class Bib2Holdings541Processor extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        this.apiUrl = `${this.baseUrl}/bib_2_holdings_541/upload`;
        this.templateUrl = `${this.baseUrl}/bib_2_holdings_541/component-template`;
